        ...
        try
        {
            ...
            if (oDs.Tables != null && oDs.Tables.Count > 0 && oDs.Tables[0].Rows.Count > 0)
            {
                table.AppendFormat(@"   <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 line'>
                                            ...
                                            <input type='text' class='form-control' id='nomeBeneficiarioEdit' value='{0}' placeholder='Nome do Beneficiário' required='required' style='width: 100%; margin: auto;' readonly/>
                                        </div>
                                        <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 line'>
                                            NIF do Beneficiário
                                            <input type='text' class='form-control' id='nifBeneficiarioEdit' value='{1}' placeholder='NIF do Beneficiário' required='required' style='width: 100%; margin: auto;' readonly/>
                                        </div>
                                        <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 line'>
                                            Matrícula
                                            <input type='text' class='form-control' id='matriculaEdit' value='{2}' placeholder='Matrícula' required='required' style='width: 100%; margin: auto;' readonly/>
                                        </div>
                                        <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 line'>
                                            Proprietário
                                            <input type='text' class='form-control' id='proprietarioEdit' value='{3}' placeholder='Proprietário' required='required' style='width: 100%; margin: auto;' readonly/>
                                        </div>
                                        <div class='col-lg-4 col-md-4 col-sm-4 col-xs-4 line'>
                                            Preço p/ KM
                                            <input type='number' class='form-control' id='precokmEdit' value='{4}' placeholder='Preço p/ KM' required='required' style='width: 100%; margin: auto;' step='any' readonly/>
                                        </div>
                                        <div class='col-lg-4 col-md-4 col-sm-4 col-xs-4 line'>
                                            Mês
